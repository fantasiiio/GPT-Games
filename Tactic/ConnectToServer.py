...
from GraphicUI import UIList, UIPanel, UIGridList, UILabel
...
class ConnectToServer():
    ...
    def init_UI(self):
        ...
        #self.panel = UIPanel(0, 0, 400, 1000, "assets\\UI\\Box03.png", border_size=23)
        #self.player_list = UIList(30, 30, list_width, 200, item_selected_callback = self.item_selected_callback)
        self.panel.add_element(self.player_list)
